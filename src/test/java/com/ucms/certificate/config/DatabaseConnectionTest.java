...
class DatabaseConnectionTest {
  ...
  @Autowired
  private com.baomidou.mybatisplus.core.mapper.BaseMapper<PublicFieldLibrary> publicFieldLibraryMapper;
  ...
  @Test
  void testPublicFieldLibraryQuery() {
    // 测试公共字段库查询成功
    long count = publicFieldLibraryMapper.selectCount(null);
